    ...
    <div className="flex flex-col gap-6">
      ...
      <section>
        <div className="flex items-center justify-between mb-3">
          ...
          <Link href="/communities/joined" className="group inline-flex items-center gap-1 text-xs font-semibold text-primary hover:text-primary/80 transition-colors">
            View all
